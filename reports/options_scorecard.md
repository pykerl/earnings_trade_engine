# Options pre-registration scorecard — through 2026-09-03

467 resolved events; 30 carried registered structures (entries frozen at registration prices — buy at ask / sell at bid).

## Calibration (all resolved events)
- realized |move| landed inside the frozen implied move in **72%** of events (vol premium says this should exceed ~50%)
- median realized/implied: **0.44** · median realized/fair: **0.78**

## Structure P&L (expiry settlement, 1 contract per registration)
- **8/30 winners · net P&L $-2,961** (gross credits/debits $14,703)
...
|---|---|---|---|---|
| cheap (model: long vol) | 8 | $-1,051 | $-512 | $-512 |
| neutral (model: no trade) | 30 | $3,993 | $-10,815 | $0 |
| rich (model: short vol) | 357 | $111,469 | $-246,646 | $111,469 |

- **Model-aligned total: $110,957** vs always-short-everything $114,411 (n=395)
